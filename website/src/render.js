...
function work(copy) {
  ...
  /* The track scrolls natively, so the section is usable with no script at
     all; the buttons stay hidden until the script that drives them runs, and
     the counter is empty until it turns the track into the filmstrip
     (`data-strip`), hidden by the stylesheet until then. */
  return `<section class="slide section work" id="work" aria-labelledby="work-title">
    <div class="container">
      ...
      <div class="carousel" data-carousel>
        ...
        <span class="work-count" data-carousel-count aria-live="polite"></span>
      </div>
    </div>
  </section>`;
}
